...
theme.titlebar_minimize_button_normal = themes_path.."default/titlebar/minimized_normal.png"
theme.titlebar_minimize_button_focus  = themes_path.."default/titlebar/minimized_focus.png"
